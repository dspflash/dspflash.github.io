...
<head>
	<title>工业互联网 数字孪生 智能制造 工业物联网 UIOT x+ works IIOT</title>

	<!-- Meta -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="x+ works工业互联网是以人机物（Human，Machines，Things）泛在互联为基础上，深度感知为支撑，智能决策为导向，精准管控为目的的细胞元化（cell，蜂窝）平台">
...
#carousel-cps{background-color: rgba(204, 204, 204, 1);}
...
<body class="header-fixed">
	<div class="wrapper">
				...
				<div class="container">
					...
					<div class="menu-container">
						...
						<div class="navbar-brand">
							...
							<span class="icon-xplus" style="font-size:3em"><span style="visibility: hidden;">X+</span></span><span style="margin-left:-2em;font-size:2em">WORKS</span>
							</a>
						</div>
						<!-- ENd Navbar Brand -->
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse one-page-nav-scrolling navbar-fixed-top one-page-nav__fixed">
						<div class="menu-container">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown page-scroll">
									<a href="#cps">
										<span data-hover="pc">数字孪生</span>
									</a>
								</li>
								<li class="dropdown page-scroll">
									<a href="#apps">
										<span data-hover="apps">典型用例</span>
									</a>
								</li>
								<li class="dropdown page-scroll">
									<a href="#support">
		...
		<div class="interactive-slider-v2 interactive-slider-v2-md img-v3">
			<div class="container">
				<div class="col-md-6"><h1>
					...
					<span><b>WORKS</b></span></p>
					<span class="cd-headline letters type">
					<span class="cd-words-wrapper">
						<b class="is-visible">助力数字化转型</b>
						<b>智能制造的基石</b>
						
					</span>
					</span>
					<p class="footer"><b>工业互联网平台</b></p>
				</h1></div>
				<div class="col-md-6"><h1>
					<p class="header"><span><b>工业APPs平台</b></span></p>
					...
					<p class="footer"><span class="cd-headline rotate-1">
						<span class="cd-words-wrapper">
							<b class="is-visible">数据驱动个性化定制</b>
							<b>APP可持续性适用</b>
						</span></span></p>
		...
		<div class="container content-md" id="about">
			<div class="row">
				<div class="col-md-6 md-margin-bottom-40">
					<h2 class="title-v2">关于 <span class="icon-xplus"><span style="visibility: hidden;">X+</span>Works</span></h2>
					<p style="text-indent:3em"><span class="icon-xplus"><span style="visibility: hidden;">X+</span></span>Works 工业互联网平台是以人机物（Human，Machines，Things）泛在互联为基础上，深度感知为支撑，智能决策为导向，精准管控为目的的细胞元化（cell，蜂窝）IT/CT/OT一体化工业系统
					</p><br>
					...
					<span class="cd-headline loading-bar" style="margin-left:-2em;font-size:.7em">
						<span class="cd-words-wrapper is-loading">
							<b class="is-visible">泛在互联</b>
						</span>
					</span>
					<span class="cd-headline letters type">
						<span class="cd-words-wrapper">
							<b class="is-visible" style="color:#72c02c;text-indent:1.2em">深度感知</b>
							<b style="color:#0096a7">智能决策</b>
							<b style="color:#0096a7">精准管控</b>
						</span>
					</span></h1>
					<h1><span class="cd-headline loading-bar" style="font-size:.6em">
						<span class="cd-words-wrapper is-loading">
							<b class="is-visible">智能制造三步走</b>
						</span>
					</span><br/>
					<span class="cd-headline letters type">
						<span class="cd-words-wrapper">
							<b class="is-visible" style="color:#0096a7;"><a href="">1.泛在物联网（UIOT人机物信息流）</a></b>
							<b style="color:#0096a7">2.工业互联网（IIOT决策流控制流）</b>
							<b style="color:#72c02c">3.智能制造（大生产体系3流畅通）</b>
						</span>
					</span>
					</h1>
					<a href="http://3ucs.com/request.php?57" target="_blank" class="btn-u btn-brd btn-brd-hover btn-u-dark">详  情</a>
				...
				<div class="col-md-6 overflow-h">
					<img class="img-responsive wow animated fadeInUp" data-wow-duration="1.5s" src="ii/xworks.png" alt="">
				</div>
			...
			<div class="row no-gutter equal-height-columns">
				<div class="col-sm-3">
					<div class="service-block service-block-purple no-margin-bottom content equal-height-column">
						...
						<h2 class="font-light">泛在互联</h2>
						<p class="no-margin-bottom font-light">UIOT泛在物联网</p>
						<p class="no-margin-bottom font-light">xAPPs应用平台人机交互</p>
						<p class="no-margin-bottom font-light">丰富的工业协议如MQTT、OPC等支撑</p>
						<p class="no-margin-bottom font-light">智能硬件让哑设备发“声”</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="service-block service-block-red no-margin-bottom content equal-height-column">
						...
						<h2 class="font-light">深度感知</h2>
						<p class="no-margin-bottom font-light">泛在互联全信息无障碍上报</p>
						<p class="no-margin-bottom font-light">RPA机器人等敏感信息自动探知</p>
						<p class="no-margin-bottom font-light">AI数学建模对历史、实时信息智能感知</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="service-block service-block-blue no-margin-bottom content equal-height-column">
						...
						<h2 class="font-light">智能决策</h2>
						<p class="no-margin-bottom font-light">智能逻辑引擎无人干预决断</p>
						<p class="no-margin-bottom font-light">可视化人工辅助决策</p>
						<p class="no-margin-bottom font-light">决策信息反馈于感知系统增强决策</p>
				...
				<div class="col-sm-3">
					<div class="service-block service-block-brown no-margin-bottom content equal-height-column">
						...
						<h2 class="font-light">精准管控</h2>
						<p class="no-margin-bottom font-light">生产过程智能化管控</p>
						<p class="no-margin-bottom font-light">供应链智能化协同</p>
						<p class="no-margin-bottom font-light">设备MRO智能化减少停机</p>
					</div>
				</div>
			</div>
		</div>
		...
		<!--=== Full Width Blocks ===-->
		<div class="container-fluid bg-color-darker" id="cps">
			<div class="row equal-height-columns no-gutter">
				<div class="col-md-6" >
					<div id='carousel-cps' class='owl-carousel owl-theme'>
						<div id='0'><img alt='3ucs xPlus' src='ii/xworks_cps.png'/></div>
					</div>
					<script>$('#carousel-cps').owlCarousel({items:1,loop:true,margin:10,autoplay:true,autoplayTimeout:3000,autoplayHoverPause:true,startPosition:0,nav:0,center:1});</script>
				</div>
		...
		<div class="container content-md" id="apps">
			<div class="text-center margin-bottom-30">
				<h2 class="title-v2 title-center">典型用例</h2>
				<p class="space-lg-hor"><span class="icon-xplus"><span style="visibility: hidden;">X+</span></span>工业物联网（IIOT）、泛在物联网（UIOT）、精益制造、产品生命周期管理、品质管理、设备健康管理、数字孪生（数字工厂）、智能服务、产线优化、智能排程、设备预测性维护、质量优化、库存优化</p>
			</div>
			...
			<div class="cube-portfolio container margin-bottom-20">
				...
				<div id="grid-container" class="cbp-l-grid-gallery">
					<div class="cbp-item illustration web-design">
						<a href="ii/ajax/desoutter.htm" class="cbp-caption cbp-singlePageInline"
							data-title="智联装配  智造精品<br>by 3UCS">
							<div class="cbp-caption-defaultWrap">
								<img src="ii/20210720_160232.png" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="cbp-l-caption-alignLeft">
									<div class="cbp-l-caption-body">
										<div class="cbp-l-caption-title">智联装配  智造精品</div>
					...
					<div class="cbp-item illustration web-design">
						<a href="ii/ajax/i3formingmachine.htm" class="cbp-caption cbp-singlePageInline"
							data-title="ERP<br>by 3UCS">
							<div class="cbp-caption-defaultWrap">
								<img src="ii/i3formingmachine.png" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="cbp-l-caption-alignLeft">
									<div class="cbp-l-caption-body">
										<div class="cbp-l-caption-title">x works</div>
					...
					<div class="cbp-item web-design">
						<a href="ii/ajax/medicine.htm" class="cbp-caption cbp-singlePageInline"
							data-title="CRM<br>by 3UCS">
							<div class="cbp-caption-defaultWrap">
								<img src="ii/medicine01.png" alt="">
							</div>
							<div class="cbp-caption-activeWrap">
								<div class="cbp-l-caption-alignLeft">
									<div class="cbp-l-caption-body">
										<div class="cbp-l-caption-title">中药调剂设备</div>
					...
					<div class="row">
						<div class="col-md-8 sm-margon-bottom-10">
							<ul class="list-inline terms-menu">
								<li class="silver">Copyright © 3UCS 2004~2021 - All Rights Reserved</li>
